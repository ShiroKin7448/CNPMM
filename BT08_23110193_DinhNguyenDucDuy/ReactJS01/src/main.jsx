...
import MomoReturnPage from "./pages/momo-return.jsx";
import AdminDashboardPage from "./pages/admin-dashboard.jsx";
import AdminStatisticsPage from "./pages/admin-statistics.jsx";
import StorePage from "./pages/store.jsx";
import AdminLoyaltyPage from "./pages/admin-loyalty.jsx";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "payment/momo-return",     element: <MomoReturnPage />    },
