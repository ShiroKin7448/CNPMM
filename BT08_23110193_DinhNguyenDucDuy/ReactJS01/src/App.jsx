...
const App = () => {
  ...
  // Fetch account khi user F5 trÃ¬nh duyá»‡t
  // Token cÃ²n trong localStorage nhÆ°ng auth context bá»‹ reset
  useEffect(() => {
  ...
  // Hiá»ƒn thá»‹ loading spinner khi Ä‘ang kiá»ƒm tra auth
  if (appLoading) {
    return (
      <div className="site-3d-shell loading-3d-screen">
        ...
        <div className="loading-card-3d">
          ...
          <span>Äang táº£i LaptopStore BT08...</span>
        </div>
      </div>
    );
  }
