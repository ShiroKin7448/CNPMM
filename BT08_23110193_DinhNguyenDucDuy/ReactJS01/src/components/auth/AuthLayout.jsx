...
const AuthLayout = ({ badge = "LaptopStore", title, subtitle, icon, children, footer }) => {
  return (
    <section className="relative min-h-[calc(100vh-64px)] overflow-hidden px-4 py-10 flex items-center justify-center bg-transparent">
      <img
        src={AUTH_BACKGROUND}
        alt=""
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 50% 40%, rgba(192,255,107,0.12), transparent 26%), linear-gradient(135deg, rgba(0,0,0,0.62) 0%, rgba(38,45,43,0.42) 52%, rgba(192,255,107,0.22) 100%)",
        }}
      />
      <div
      ...
      <div className="relative z-10 w-full max-w-[440px]">
        ...
        <div className="auth-card-3d rounded-[28px] border border-[#D5D5D5]/70 bg-white/95 p-7 shadow-2xl shadow-black/35 backdrop-blur-md sm:p-8">
